...
Partial Public Class dsLabel
    ...
    Partial Public Class DataTable1DataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute()>  _
        Public Overloads Function AddDataTable1Row(ByVal LocationCode As String, ByVal TPLNo As String, ByVal TPLAttn As String, ByVal RowNo As Double, ByVal CustCode As String, ByVal CustName As String, ByVal InvoiceNo As String, ByVal DONo As String, ByVal Department As String, ByVal Remark As String, ByVal mCount As Decimal, ByVal Quantity As Decimal, ByVal UOM As String) As DataTable1Row
            Dim rowDataTable1Row As DataTable1Row = CType(Me.NewRow,DataTable1Row)
            Dim columnValuesArray() As Object = New Object() {LocationCode, TPLNo, TPLAttn, RowNo, CustCode, CustName, InvoiceNo, DONo, Department, Remark, mCount, Quantity, UOM}
